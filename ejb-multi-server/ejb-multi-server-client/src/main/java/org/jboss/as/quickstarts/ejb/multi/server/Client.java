...
import com.org.jboss.mainApp.MainApp;
 ...
 * </p>
 * <p>
 * With the boolean property <i>UseEjbClient34</i> the basic example or the example with the scoped-environment will be
 * called.
 * </p>
 * 
...
public class Client {
    ...
    public static void main(String... args) throws Exception {
        ...
        final String rcal = "ejb:jboss-ejb-multi-server-app-main/ejb//"
                + (useScopedExample ? "MainEjbClient34AppBean" : "MainAppBean") + "!" + MainApp.class.getName();
