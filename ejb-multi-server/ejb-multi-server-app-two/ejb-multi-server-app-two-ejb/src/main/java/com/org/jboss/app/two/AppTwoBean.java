 ...
 * role. The security-domain is declared by the JBoss specific annotation SecurityDomain.
 * 
...
public @Stateless class AppTwoBean implements AppTwo {
    ...
    public String invokeSecured(String text) {
        ...
        LOGGER.info("Is in Role AppTwo=" + context.isCallerInRole("AppTwo") + " Intern="
