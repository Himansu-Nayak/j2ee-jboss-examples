 ...
 */
package com.org.jboss.asynchronous;
...
public interface AsynchronousAccess {
    ...
    /**
     * A method which is called and will not returning a result. It will be started and run to complete the work. The
     * sleep should simulate a complex action.
     */
    void fireAndForget(long sleepTime);

    /**
     * A method which is called and will return a result. It will be started and return the result after completed the
     * work. The sleep should simulate a complex action.
     */
     ...
     * @return never
     * @throws Exception
     *             ever for demonstration purpose
     */
