...
1. `asynchronous-ejb`: This module contains the EJB's and will be deployed to the server
2. `asynchronous-client` : This module contains a remote EJB client
