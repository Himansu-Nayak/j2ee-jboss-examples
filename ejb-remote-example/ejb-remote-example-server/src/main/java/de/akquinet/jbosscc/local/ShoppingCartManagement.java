...
public class ShoppingCartManagement implements ShoppingCartManagementMXBean {
    ...
    public void register() {
        try {
            objectName = new ObjectName("de.akquinet.jbosscc:shopping=" + this.getClass().getName());
            platformMBeanServer = ManagementFactory.getPlatformMBeanServer();
            platformMBeanServer.registerMBean(sessionContext.getBusinessObject(ShoppingCartManagementMXBean.class),
                    objectName);
        } catch (Exception e) {
