package com.org.jboss.cluster.client;

import com.org.jboss.cluster.ClusteredStatefulBean;
import com.org.jboss.cluster.ClusteredStatelessBean;
import com.org.jboss.cluster.RemoteStateful;
import com.org.jboss.cluster.RemoteStateless;
...
public class RemoteEJBClient {
     ...
     * jboss-ejb-client.properties, or purely programmatically without any properties files. If this is set to true, an
     * existing jboss-ejb-client.properties file may lead to conflicts. Also, the initial servers must all be up and
     * running (unlike when using jboss-ejb-client.properties).
     */
    ...
    public RemoteStateless lookupRemoteStatelessBean() throws NamingException {
        ...
        // ejb:/cluster//ClusteredStatelessBean!RemoteStateless
    ...
    public RemoteStateful lookupRemoteStatefulBean() throws NamingException {
        ...
        // ejb:/cluster//ClusteredStatefulBean!RemoteStateful?stateful
        final String jndiName = "ejb:" + appName + '/' + moduleName + '/' + distinctName + '/'
