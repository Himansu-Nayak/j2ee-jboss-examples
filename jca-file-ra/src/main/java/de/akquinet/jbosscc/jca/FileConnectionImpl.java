...
public class FileConnectionImpl implements FileConnection {
    private static Logger LOG = Logger.getLogger(FileConnectionImpl.class.getName());
     ...
     */
    public FileConnectionImpl(FileManagedConnection mc, FileManagedConnectionFactory mcf) {
        this.mc = mc;
    }
