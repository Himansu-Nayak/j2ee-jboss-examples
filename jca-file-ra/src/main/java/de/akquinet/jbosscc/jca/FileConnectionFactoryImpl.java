...
public class FileConnectionFactoryImpl implements FileConnectionFactory {
    ...
    private static Logger log = Logger.getLogger(FileConnectionFactoryImpl.class.getName());
    ...
    public FileConnectionFactoryImpl(FileManagedConnectionFactory mcf, ConnectionManager cxManager) {
        this.mcf = mcf;
