 ...
 */
package com.org.cdi.injection.backing;

import javax.inject.Inject;
import javax.inject.Named;

import com.org.cdi.injection.interfaces.TranslateService;
import com.org.cdi.injection.qualifier.English;
import com.org.cdi.injection.qualifier.Hindi;
import com.org.cdi.injection.qualifier.Spanish;
...
public class TranslationBackingBean {
    ...
    /*
     * Both of these injections is of the same base type: TranslationService, however, CDI is using the qualifiers to
     * help narrow which of the two implementations should be injected.
     */
    ...
    @Inject
    @Hindi
    private TranslateService hindiTranslateService;
    ...
    public String getHindiHello() {
        return hindiTranslateService.hello();
    }
