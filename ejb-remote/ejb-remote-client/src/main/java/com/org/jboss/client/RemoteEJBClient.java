...
import com.org.jboss.remote.stateful.RemoteCounter;
import com.org.jboss.remote.stateless.RemoteCalculator;
...
/**
 * A sample program which acts a remote client for a EJB deployed on AS7 server. This program shows how to lookup
 * stateful and stateless beans via JNDI and then invoke on them
 *
 * The main method will be executed by the exec-maven-plugin defined in the pom
 *
 * @author Jaikiran Pai
 */
public class RemoteEJBClient {
    ...
    private static RemoteCalculator lookupRemoteStatelessCalculator() throws NamingException {
        ...
        return (RemoteCalculator) context
                .lookup("ejb:/ejb-remote-server-side/CalculatorBean!" + RemoteCalculator.class.getName());
    }
    ...
    private static RemoteCounter lookupRemoteStatefulCounter() throws NamingException {
        ...
        return (RemoteCounter) context
                .lookup("ejb:/ejb-remote-server-side/CounterBean!" + RemoteCounter.class.getName() + "?stateful");
    }
}
