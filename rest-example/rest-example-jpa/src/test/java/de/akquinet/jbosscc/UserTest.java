...
public class UserTest {
    ...
    public void testPersist() throws Exception {
        ...
        User userFromDb = databaseRule.getEntityManager().find(User.class, user.getId());
    ...
    public void testUniqueUsername() throws Exception {
        ...
        databaseRule.getTransactionHelper().executeInTransaction(new VoidRunnable() {
            ...
            public void doRun(EntityManager entityManager) throws Exception {
                databaseRule.getEntityManager().persist(new UserTestdataBuilder().withUsername("username").build());
