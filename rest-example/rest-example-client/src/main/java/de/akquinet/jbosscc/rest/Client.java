...
public class Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        client.print(client.get("http://localhost:8080/rest-example/rest/user/1", MediaType.APPLICATION_JSON_TYPE));

        client.print(client.get("http://localhost:8080/rest-example/rest/user/3", MediaType.TEXT_XML_TYPE));

        client.print(client.get("http://localhost:8080/rest-example/rest/user", MediaType.TEXT_XML_TYPE));
        ...
        client.post("http://localhost:8080/rest-example/rest/user", MediaType.TEXT_XML,
    ...
    public ClientResponse<String> get(String url, MediaType mediaType) throws Exception {
    ...
    public ClientResponse<String> delete(String url, MediaType mediaType) throws Exception {
        ClientRequest request = new ClientRequest(url);
    ...
    public ClientResponse<String> put(String url, String contentType, Object data) throws Exception {
        ClientRequest request = new ClientRequest(url);
    ...
    public ClientResponse<String> post(String url, String contentType, Object data) throws Exception {
        ClientRequest request = new ClientRequest(url);
