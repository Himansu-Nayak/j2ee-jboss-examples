...
* Comment the `<class>AuditInterceptor</class>` and you will no longer see the audit history on the browser page.
...
* Comment the `<stereotype>ServiceStereotype</stereotype>` and you no longer see ItemAlternativeServiceBean implementation invoked.
