...
/**
 * The remote client responsible for making a number of calls to the server to demonstrate the capabilities of the
 * interceptors.
 * 
...
public class RemoteClient {
    ...
    private static void performTestingSecurityContext(final String user, final SecuredEJBRemote secured,
        ...
        try {
            ...
            System.out.println("-------------------------------------------------");
            System.out.println(
                    String.format("* * About to perform test as %s * *\n\n", user == null ? "ConnectionUser" : user));
    ...
    /**
     * Perform the tests of this quick start using the ClientLoginModule and LoginContext API to set the desired
     * Principal.
     */
