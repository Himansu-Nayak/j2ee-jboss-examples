...
command to enable jboss logging level using jboss-cli are

1. /subsystem=logging/logger=com.org.jboss.logging:add(level=TRACE)  
  
2. /subsystem=logging/logger=com.org.jboss.logging:remove
