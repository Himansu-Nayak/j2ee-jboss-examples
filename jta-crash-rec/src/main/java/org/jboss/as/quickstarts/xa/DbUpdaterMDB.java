...
/**
 * <p>
 * A Message Driven Bean that asynchronously receives and processes messages of the form key=value and updates a
 * database table with those values using the services of an injected bean.
 * </p>
 *
    ...
    public void onMessage(Message rcvMessage) {
        ...
        try {
            if (rcvMessage instanceof TextMessage) {
                ...
                LOGGER.warning(
                        "JTA Crash Record Quickstart: Unexpected message. Type: " + rcvMessage.getClass().getName());
            }
