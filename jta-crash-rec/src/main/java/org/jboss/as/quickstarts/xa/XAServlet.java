...
public class XAServlet extends HttpServlet {
    ...
    private static String PAGE_CONTENT = "<h2>XA Recovery</h2>"
            ...
            + "In this example, you can perform the following operations:</p>" + "<ul>"
            ...
            + "<li>The refresh the list, click the <i>Refresh Table</i> link.</li>" + "</ul>" +

            "<p>To demonstrate XA recovery, you will take the following steps:</p> " + "<ol>"
            + "<li>Add a <b>key</b>/<b>value</b> as described above.</li>" + "<li>Stop the JBoss server.</li>"
            + "<li>Clear any transaction objectstore data remaining from previous tests.</li>"
            + "<li>Configure Byteman to halt the JBoss server.</li>" + "<li>Start the JBoss server.</li>"
            + "<li>Add another <b>key</b>/<b>value</b>. This will cause Byteman to halt the JBoss server.</li>"
            + "<li>Verify the database record.</li>" + "<li>Disable Byteman.</li>" + "<li>Start the JBoss server.</li>"
            ...
            "<form>" + "Key: <input type=\"text\" name=\"key\" />"
            ...
            + "&nbsp;Delete a pair (or all pairs if key is blank).<br />" + "</form>"
     ...
     * </p>
     * <p>
     * The behaviour of the servlet is controlled by servlet query parameters:
     * </p>
     * <p>
     * Database inserts/updates are controlled by the presence of parameters "submit" (with value "Submit") and "key".
     * </p>
     * <p>
     * Database deletes are controlled by the presence of parameters "submit" (with value "Delete") and "key". If the
     * value of "key" is empty then all rows are deleted otherwise just the row with the key value is deleted.
     * </p>
     * 
     * @param req
     *            the HTTP request
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        /*
         * Read servlet parameters to determine which key value pair to use and whether this is an insert/update/list
         * request or a delete request
         * 
