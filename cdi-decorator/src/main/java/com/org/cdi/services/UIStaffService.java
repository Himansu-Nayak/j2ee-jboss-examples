 ...
 */
public class UIStaffService implements StaffService {

    @Override
    public Staff getStaff() {
        Staff staff = new Staff();
        staff.setPosition("UI Developer");
        staff.setBonus(100);
        return staff;
    }
     ...
     * {@link com.org.cdi.decorator.StaffServiceDecorator} are abstract and do not wrap deleteStaff(Staff staff) method.
     * 
     */
    @Override
