 ...
 */
package com.org.jboss.controller;

import javax.ejb.EJB;
import javax.enterprise.context.RequestScoped;
import javax.inject.Named;

import com.org.jboss.client.GreeterEJBLocal;
import com.org.jboss.client.GreeterException;

/**
 * @author bmaxwell
 *
 * @Named defaults to the name of the class with the first letter lower case so this bean can be referred to as
 *        greeterBean in a JSF page It is RequestScoped so nothing is maintained beyond the request/response.
 */
@Named
@RequestScoped
public class GreeterBean {
    ...
    /*
     * And instance variable to hold the EJB response or exception message that is bound to the outputText on the JSF
     * page
     */
    ...
    /**
     * The name setter will be called when the user submits the JSF page and pass the value which can be usined in the
     * sayHello action
     * 
     * @param name
     *            the string which is bound to the JSF page inputText
     */
