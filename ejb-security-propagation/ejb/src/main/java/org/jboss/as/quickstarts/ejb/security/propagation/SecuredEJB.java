...
/**
 * 
 * Annotate this EJB for authorization. Allow only those in the "admin" role. For EJB authorization, you must also
 * specify the security domain. This example uses the "security-propagation-quickstart" security domain.
 *
 */
@Stateless
