...
final class SecurityActions {
     ...
     */
    static SecurityContext securityContextSetPrincipalInfo(final Principal principal,
            final OuterUserCredential credential) throws Exception {
    ...
    private interface SecurityContextActions {
        ...
        SecurityContextActions NON_PRIVILEGED = new SecurityContextActions() {
            ...
            public SecurityContext setPrincipalInfo(Principal principal, OuterUserCredential credential)
                    throws Exception {
        ...
        SecurityContext setPrincipalInfo(final Principal principal, final OuterUserCredential credential)
                throws Exception;
