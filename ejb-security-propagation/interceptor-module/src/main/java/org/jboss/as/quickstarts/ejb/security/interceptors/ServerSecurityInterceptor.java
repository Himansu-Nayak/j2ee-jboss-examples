...
/**
 * The server side security interceptor responsible for handling any security identity propagated from the client. This
 * interceptor is configured in jboss-ejb3.xml of the application package.
 * 
        ...
        try {
            if (desiredUser != null && connectionUser != null
                ...
                try {
                    ...
                    logger.error("Failed to switch security context for user", exception);
