...
/**
 * A simple Servlet which calls a non-secured EJB. It's only purpose is to call a remote EJB and test the
...
public class HelloServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.println("<p>" + "Hello Authentication Type : " + authType + "</p>");
