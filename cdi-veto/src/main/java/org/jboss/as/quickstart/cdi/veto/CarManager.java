...
public class CarManager {
    ...
    /**
     * Returns either a new instance or a managed instance of {@link Car}. The produced entity should be dependent
     * scoped to avoid incompatible proxies between JPA and CDI.
     */
    @Produces
    public Car getCar() {
        if (id == null) {
    ...
    public void save(Car car) {
        try {
            ...
            log.severe("Transaction Error: " + exception.getMessage());
