...
final class SecurityActions {
    ...
    private static RemotingContextActions remotingContextActions() {
        return System.getSecurityManager() == null ? RemotingContextActions.NON_PRIVILEGED
                : RemotingContextActions.PRIVILEGED;
    }
    ...
    private static SecurityContextActions securityContextActions() {
        return System.getSecurityManager() == null ? SecurityContextActions.NON_PRIVILEGED
                : SecurityContextActions.PRIVILEGED;
    }
     ...
     *
     * SecurityContext setPrincipalInfo(final Principal principal, final OuterUserCredential credential) throws
     * Exception;
     *
     ...
     *
     * public SecurityContext setPrincipalInfo(final Principal principal, final OuterUserCredential credential) throws
     * Exception { try { return AccessController.doPrivileged(new PrivilegedExceptionAction<SecurityContext>() {
     *
     * public SecurityContext run() throws Exception { return NON_PRIVILEGED.setPrincipalInfo(principal, credential); }
     * }); } catch (PrivilegedActionException exception) { throw exception.getException(); } }
     *
     * };
     *
     * }
    ...
    private interface SecurityContextActions {
        ...
        SecurityContextActions PRIVILEGED = new SecurityContextActions() {
            ...
            @Override
            public SecurityContext setPrincipalCredential(final Principal principal, final Object credential)
                    throws Exception {
                try {
