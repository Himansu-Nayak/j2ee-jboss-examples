...
/**
 * A specialised login module to authenticate the user by taking the previously authenticated identity from the
 * connection and verifying it with additional data.
 *
