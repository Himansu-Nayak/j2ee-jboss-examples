...
public class TriangleService implements Service<SimpleShape> {
    ...
    public static final ServiceName SERVICE_NAME = ServiceName.of("TRIANGLE_SHAPE");

    private Triangle square;

    @Override
    public SimpleShape getValue() throws IllegalStateException, IllegalArgumentException {
        return square;
    }
