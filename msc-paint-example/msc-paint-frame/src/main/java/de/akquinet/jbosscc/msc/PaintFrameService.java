...
public class PaintFrameService implements Service<PaintFrame> {
    ...
    public static final ServiceName SERVICE_NAME = ServiceName.of("PAINT_FRAME");
    ...
    @Override
    public PaintFrame getValue() throws IllegalStateException, IllegalArgumentException {
        return frame;
    }
