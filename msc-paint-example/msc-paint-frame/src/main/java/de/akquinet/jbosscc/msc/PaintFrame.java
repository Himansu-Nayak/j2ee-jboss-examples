...
/**
 * This class represents the main application class, which is a JFrame subclass that manages a toolbar of shapes and a
 * drawing canvas. This class does not directly interact with the underlying OSGi framework; instead, it is injected
 * with the available <tt>SimpleShape</tt> instances to eliminate any dependencies on the OSGi application programming
 * interfaces.
 **/
public class PaintFrame extends JFrame implements MouseListener, MouseMotionListener {
     ...
     * @return The corresponding <tt>SimpleShape</tt> instance if available or <tt>null</tt>.
     **/
    ...
    /**
     * Simple action listener for shape tool bar buttons that sets the drawing frame's currently selected shape when
