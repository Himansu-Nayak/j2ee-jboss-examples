...
public class CommentTestdataBuilder extends AbstractTestdataBuilder<Comment> {
    ...
    private User getAuthor() {
        ...
        return hasEntityManager() ? new UserTestdataBuilder(getEntityManager()).buildAndSave()
    ...
    private BlogEntry getBlogEntry() {
        ...
        return hasEntityManager() ? new BlogEntryTestdataBuilder(getEntityManager()).buildAndSave()
