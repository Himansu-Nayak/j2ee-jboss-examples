...
public class BlogEntryTest {
    ...
    public void testPersist() throws Exception {
        BlogEntry blogEntry = new BlogEntryTestdataBuilder(entityManager).buildAndSave();

        BlogEntry blogEntryFromDb = entityManager.find(BlogEntry.class, blogEntry.getId());
    ...
    public void testPersistWithoutAuthor() throws Exception {
        final BlogEntry blogEntry = new BlogEntryTestdataBuilder(entityManager).build();
