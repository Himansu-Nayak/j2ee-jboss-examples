...
public class BlogEntryListServiceTest {
    ...
    public void testGetResultList() throws Exception {
        EasyMock.expect(blogEntryDaoMock.find(5, 0)).andReturn(Arrays.asList(new BlogEntryTestdataBuilder().build()));
    ...
    public void testPagination() throws Exception {
        ...
        Assert.assertEquals(Integer.valueOf(0), blogEntryListService.getFirstResult());
        ...
        Assert.assertEquals(Integer.valueOf(5), blogEntryListService.getFirstResult());
