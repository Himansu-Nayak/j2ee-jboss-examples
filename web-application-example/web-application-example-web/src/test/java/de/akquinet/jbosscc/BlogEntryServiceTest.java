...
public class BlogEntryServiceTest {
    ...
    @Rule
    public NeedleRule needleRule = new NeedleRule(databaseRule, new CurrentUserInjectionProvider());
    ...
    public void testPersistNewInstance() throws Exception {
        ...
        final Long id = databaseRule.getTransactionHelper().executeInTransaction(new Runnable<Long>() {
        ...
        BlogEntry blogEntry = databaseRule.getTransactionHelper().loadObject(BlogEntry.class, id);
    ...
    public void testGetInstanceById() throws Exception {
        BlogEntry blogEntry = new BlogEntryTestdataBuilder(databaseRule.getEntityManager()).buildAndSave();
    ...
    public void testDelete() throws Exception {
        ...
        EasyMock.expect(conversationMock.isTransient()).andReturn(false).anyTimes();
        ...
        BlogEntry loadObject = databaseRule.getTransactionHelper().loadObject(BlogEntry.class, blogEntry.getId());
