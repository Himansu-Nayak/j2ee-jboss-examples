...
public class CommentServiceTest {
    ...
    @Rule
    public NeedleRule needleRule = new NeedleRule(new CurrentUserInjectionProvider(), databaseRule);
    ...
    @SuppressWarnings("unused")
    @InjectIntoMany
    private BlogEntry blogEntry = new BlogEntryTestdataBuilder(databaseRule.getEntityManager()).buildAndSave();

    @Test
    public void testCreateAndPersist() throws Exception {
        TransactionHelper transactionHelper = databaseRule.getTransactionHelper();
        ...
        Comment commentFromDb = databaseRule.getTransactionHelper().loadObject(Comment.class, id);
