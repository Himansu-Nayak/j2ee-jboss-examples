...
public class SingletonServiceClient {
    ...
    private SingletonServiceClient() throws NamingException {
        ...
        String lookupName = "ejb:/jboss-as-cluster-ha-singleton-service/ServiceAccessBean!"
    ...
    /**
     * Call the EJB 4 times to demonstrate that despite load balancing the SingletonService is called at the same
     * server.
     *
     * @param args
     *            no arguments needed
