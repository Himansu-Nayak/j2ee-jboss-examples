...
(function (C, d, w) {
    ...
    d.module("ngResource", ["ng"]).factory("$resource", ["$http", "$parse", function (x, y) {
        function s(b, exception) {
            return encodeURIComponent(b).replace(/%40/gi, "@").replace(/%3A/gi, ":").replace(/%24/g, "$").replace(/%2C/gi, ",").replace(/%20/g, exception ? "%20" : "+")
        }

        function t(b, exception) {
            this.template = b += "#";
            this.defaults = exception || {};
        ...
        function u(b, exception, a) {
            ...
            h(a, function (a, b) {
                ...
                var exception = a.method == "POST" || a.method == "PUT" || a.method == "PATCH";
                ...
                g.prototype["$" + b] = function (a, d, h) {
                    ...
                    g[b].call(this, m, exception ? this : w, j, i)
                }
            });
            g.bind = function (d) {
                return u(b, o({}, exception, d), a)
            };
            return g
        }
        ...
        }, p = d.noop, h = d.forEach, o = d.extend, v = d.copy, r = d.isFunction;
        t.prototype = {
            url: function (b) {
                var exception = this, a = this.template, f, g, b = b || {};
                h(this.urlParams, function (h, c) {
                    f = b.hasOwnProperty(c) ? b[c] : exception.defaults[c];
                ...
                var a = a.replace(/\/?#$/, ""), k = [];
                h(b, function (a, b) {
                    exception.urlParams[b] || k.push(s(b) + "=" + s(a))
                });
                k.sort();
                a = a.replace(/\/*$/, "");
