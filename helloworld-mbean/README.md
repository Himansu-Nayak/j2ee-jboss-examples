...
This example demonstrates the use of *CDI 1.0* and *MBean* in  Red Hat JBoss Enterprise Application Platform. The project also includes a set of Arquillian tests for mbean.

The example is composed of mbean. They are as follows :
