...
public class MXComponentHelloWorldTest {
    ...
    public static Archive<?> createTestArchive() {
        return ShrinkWrap.create(JavaArchive.class, "helloworld.jar").addClasses(MXComponentHelloWorld.class)
                .addClasses(AbstractComponentMBean.class).addClass(IHelloWorldMXBean.class).addClass(HelloService.class)
