...
public abstract class AbstractComponentMBean {
    ...
    protected void startup() {
        ...
        try {
            ...
            throw new IllegalStateException("Error during registration of " + name + " into JMX:" + exception,
                    exception);
        }
    }
    ...
    protected void destroy() {
        ...
        try {
            ...
            throw new IllegalStateException("Error during unregistration of " + name + " into JMX:" + exception,
                    exception);
        }
    }
