...
public class MXPojoHelloWorldTest {
    ...
    public static Archive<?> createTestArchive() {
        return ShrinkWrap.create(JavaArchive.class, "myservice.sar").addClasses(MXPojoHelloWorld.class)
                .addClasses(IHelloWorldMXBean.class)
    ...
    public void testHello() throws Exception {
        ...
        Assert.assertEquals("Welcome jer!", mbeanServer.invoke(objectName, "sayHello", new Object[] { "jer" },
